...
"nnoremap <leader>hj :lua require("harpoon.mark").promote()<CR>
"nnoremap <leader>ty :lua require("harpoon.term").gotoTerminal(1)<CR>
"nnoremap <leader>tu :lua require("harpoon.term").gotoTerminal(2)<CR>
"nnoremap <leader>cy :lua require("harpoon.term").sendCommand(1, 1)<CR>
"nnoremap <leader>cu :lua require("harpoon.term").sendCommand(1, 2)<CR>
